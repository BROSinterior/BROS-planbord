...
- Vereist `sql/016_werf.sql` (tabellen `werfbezoeken`, `vaststellingen`, bucket `werf`, realtime) en `sql/018_werf_taken.sql`. Alleen het team (beheer + medewerker) kan lezen en schrijven; de klant ziet in stap 1 enkel de vaststellingen die hem als taak toegewezen zijn.
